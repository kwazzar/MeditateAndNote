...
- [x] Merge `task2` → `main` — зроблено 2026-09-25 (чистий, без конфліктів; 446 unit + 4 UI green на `main`)
- [x] **Після merge:** `ARCHITECTURE.md` оновлено — секція "Semantic Search (Sprint 4 — built, fallback disabled)"
- [x] Ручний QA — 20/20 PASS (закрито 2026-09-25, див. `QA_LOG.md`)
...
**Ручний QA чекліст → закритий через `QA_LOG.md` (20/20 PASS, 2026-09-25).**
Недокументованим лишився лише пункт «свайп угори ховає клавіатуру» (стандартна поведінка iOS, не логувався окремо).
