...
| 14 | Edit Groceries→Grocery list | `Groceries` не б'є | PASS* | ланцюг `Gro→Groce→Grove(0,тапo мало)→Gro`; фінального пошуку `Groceries` у логу нема — підтвердити |
...
|--------|------|-----------|----------|
| 1 | 2026-09-23 | 16 PASS (2 автоматизовано UI-тестом), 4 не покрито | Лишилось: п.17–20 (візуальні/інша категорія — юзер); п.14 фінально підтвердити |