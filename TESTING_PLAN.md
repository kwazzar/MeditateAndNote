...
- **CI**: пропущено (2026-09-04). Соло-проєкт з низьким PR-трафіком: macos-runner дорогий (~5–10 хв × ~10–20× Linux), iOS 26 SDK не гарантовано на `macos-latest`, а поріг 33% захищає лише від різкого падіння. Переглянути, коли coverage ≥ 50% або з'явиться регулярний PR-трафік.
